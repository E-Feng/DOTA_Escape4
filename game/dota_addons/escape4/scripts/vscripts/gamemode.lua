...
function barebones:InitGameMode()
  ...
  EntList = {
                ...
                {2, ENT_PATRL, 0, "p1_1_1a",  "PatrolInitial", 1,  0.03, 450, 0.5},
                {2, ENT_PATRL, 0, "p1_1_2a",  "PatrolInitial", 2,  0.03, 300, 0.5},
                {2, ENT_PATRL, 0, "p1_1_3a",  "PatrolInitial", 3,  0.03, 260, 0.5},
                {2, ENT_PATRL, 0, "p1_1_4a",  "PatrolInitial", 4,  0.03, 475, 0.5},
                {2, ENT_PATRL, 0, "p1_1_5a",  "PatrolInitial", 5,  0.03, 380, 0.5},
                {2, ENT_PATRL, 0, "p1_1_6a",  "PatrolInitial", 6,  0.03, 340, 0.5},
                {2, ENT_PATRL, 0, "p1_1_7a",  "PatrolInitial", 7,  0.03, 280, 0.5},
                {2, ENT_PATRL, 0, "p1_1_8a",  "PatrolInitial", 8,  0.03, 360, 0.5},
                {2, ENT_PATRL, 0, "p1_1_9a",  "PatrolInitial", 9,  0.03, 400, 0.5},
                {2, ENT_PATRL, 0, "p1_1_10a",  "PatrolInitial", 10, 0.03, 450, 0.5},
                ...
                {2, ENT_PATRL, 0, "p1_2_1a",  "PatrolInitial", 11,  0.03, 450, 0.5},
                {2, ENT_PATRL, 0, "p1_2_2a",  "PatrolInitial", 12,  0.03, 280, 0.5},
                {2, ENT_PATRL, 0, "p1_2_3a",  "PatrolInitial", 13,  0.03, 340, 0.5},
                {2, ENT_PATRL, 0, "p1_2_4a",  "PatrolInitial", 14,  0.03, 300, 0.5},
                {2, ENT_PATRL, 0, "p1_2_5a",  "PatrolInitial", 15,  0.03, 380, 0.5},
                {2, ENT_PATRL, 0, "p1_2_6a",  "PatrolInitial", 16,  0.03, 400, 0.5},
                {2, ENT_PATRL, 0, "p1_2_7a",  "PatrolInitial", 17,  0.03, 475, 0.5},
                {2, ENT_PATRL, 0, "p1_2_8a",  "PatrolInitial", 18,  0.03, 360, 0.5},
                {2, ENT_PATRL, 0, "p1_2_9a",  "PatrolInitial", 19,  0.03, 440, 0.5},
                {2, ENT_PATRL, 0, "p1_2_10a",  "PatrolInitial", 20, 0.03, 260, 0.5},
								{2, ENT_PATRL, 0, "p1_2_11a",  "PatrolInitial", 21, 0.03, 300, 0.5},
                {2, ENT_PATRL, 0, "p1_2_12a",  "PatrolInitial", 22, 0.03, 450, 0.5},
								-- Split of multi patrol vs single
								{2, ENT_PATRL, 0, "p1_3_1a",  "PatrolInitial", 23, 0.03, 400, 0.5},
								{2, ENT_PATRL, 0, "p1_3_2a",  "PatrolInitial", 24, 0.03, 400, 0.5},
								{2, ENT_PATRL, 0, "p1_3_3a",  "PatrolInitial", 25, 0.03, 425, 0.5},
								{2, ENT_PATRL, 0, "p1_3_4a",  "PatrolInitial", 26, 0.03, 425, 0.5},
              },
							{ -- Level 2
							...
							{ -- Level 3
								...
								{2, ENT_PATRL, 0, "p3_1a", "PatrolInitial", 31, 0.03, 400},
								{2, ENT_PATRL, 0, "p3_2a", "PatrolInitial", 32, 0.03, 400},
								{2, ENT_PATRL, 0, "p3_3a", "PatrolInitial", 33, 0.03, 400},
                ...
                {1, ENT_MANGO, 0, "mango3_11", nil, true},
								{2, ENT_PATRL, 0, "p3_1_1a", "PatrolInitial", 34, 0.03, 275, 0.5}, 
                ...
                {1, ENT_MANGO, 0, "mango3_12", nil, true},
							...
							{ -- Level 4 
								...
								{2, ENT_MULTI, 0, "m4_1a", "MultiPatrolThinker", "m4_1b", 975, 0, 450},
								...
								{2, ENT_PATRL, 0, "p4_1a", "PatrolInitial", 37, 0.03, 400, 0.25},
								{2, ENT_PATRL, 0, "p4_2a", "PatrolInitial", 38, 0.03, 400, 0.25},
								{2, ENT_PATRL, 0, "p4_3a", "PatrolInitial", 39, 0.03, 400},
								...
								{2, ENT_PATRL, 0, "p4_4a", "PatrolInitial", 40, 0.03, 450},
								{2, ENT_PATRL, 0, "p4_z1", "PatrolInitial", 0, 0.03, 450},
								{2, ENT_PATRL, 0, "p4_z2", "PatrolInitial", 0, 0.03, 450},
								{2, ENT_PATRL, 0, "p4_z3", "PatrolInitial", 0, 0.03, 450},
								{2, ENT_PATRL, 0, "p4_z4", "PatrolInitial", 0, 0.03, 450},
								{2, ENT_PATRL, 0, "p4_z5", "PatrolInitial", 0, 0.03, 450},
								{2, ENT_PATRL, 0, "p4_z6", "PatrolInitial", 0, 0.03, 450},
